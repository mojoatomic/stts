...
Download [N-CMAPSS](https://phm-datasets.s3.amazonaws.com/NASA/17.+Turbofan+Engine+Degradation+Simulation+Data+Set+2.zip) (~14 GB zip) and place `.h5` files in `data/N-CMAPSSData/`.
